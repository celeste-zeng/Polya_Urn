...
<img src="single_urn.png" width="80%" height="80%"/>

These 5 trials have the exact same initial conditions (1 black ball and 1 red ball), but the limits to which each urn converges 
...
Reflecting on this conclusion, let's look back at the first 2 plots. The limit generated by one Polya urn is a simulation/sample from the corresponding Beta(a,b), which also explains why the limit is random.
